...
public class Dashboard extends javax.swing.JFrame implements MulticastListener{
    ...
    public Dashboard() {
        ...
        multicastServer.setMulticastListener(this);
    ...
    JList list = (JList)evt.getSource();
        if (evt.getClickCount() == 2) {
            ...
            ServerFile[] rootFiles = MainController.getRootContent(cm.getAddress());            
            new FileExplorer(rootFiles,cm).setVisible(true);
        }
