...
public class FileExplorer extends javax.swing.JFrame {
    ...
    private ArrayList<ServerFile[]> stack;
    private int currentIndex = 0;
    
    public FileExplorer(ServerFile[] rootFiles,ClientModel user) {
        initComponents();
    ...
    private void refresh(ServerFile[] file){
        
        DefaultListModel model = new DefaultListModel();
         
        for(ServerFile f:file){
            model.addElement(new FileModel(f.getName(), f.isIsFile(),f.getFullName()));
        }
...
//                MyLogger.log("Descargar...");
                ...
                ServerFile[] rootFiles = MainController.getFolderContent(user.getAddress(),cm.getFullPath());
                stack.add(rootFiles);
                currentIndex++;
                refresh(rootFiles);
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(currentIndex > 0){
            --currentIndex;
            ServerFile[] files = stack.get(currentIndex);
            refresh(files);
        }else{
            currentIndex = 0;
        }
