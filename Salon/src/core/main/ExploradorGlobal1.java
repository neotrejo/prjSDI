 ...
 * @author SDI
 */
public class ExploradorGlobal1 extends javax.swing.JFrame {
    ...
    private ExploradorGlobal1(User user) throws PropertyVetoException {
        initComponents();
        ...
        String[] headSession = {"Fecha", "Hora", "Curso", "Salon", "Archivo", "", ""};
    ...
    public static ExploradorGlobal1 getInstance(User user) throws PropertyVetoException {
        if (instance == null) {
            instance = new ExploradorGlobal1(user);
        }
        return instance;
    }
    ...
    private void setFieldsSubject(Course course) {
        ...
        passwordTextF.setText(course.getPasskey());
    ...
    private void initComponents() {
        ...
        formaSessionIFrameLayout.setVerticalGroup(
            ...
            .addGroup(formaSessionIFrameLayout.createSequentialGroup()
                ...
                .addComponent(savedSessBtn)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(logSessLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//
    ...
    private void savedSubscriptionBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savedSubscriptionBtnActionPerformed
        if (!passwordSubscField.getText().isEmpty()) {
            course = MainController.existSubjectNamePass(subjectsSubsCb.getSelectedItem().toString(), passwordSubscField.getText());
            if (course != null) {
