...
//        tabPanel.setMnemonicAt(0, KeyEvent.VK_1);
        tabPanel.remove(0);
        tabPanel.setTitleAt(0, "Sesiones");
        tabPanel.setMnemonicAt(0, KeyEvent.VK_1);
        tabPanel.setTitleAt(1, "Subscripciones");
        tabPanel.setMnemonicAt(0, KeyEvent.VK_2);
    ...
    private void updateSessionTable(boolean clean) {
        ...
        sessions = MainController.getSessionsActives(user.getId(),dtf.format(firstDate));
        if (sessions != null || sessions.size() == 0) {
            sessions.forEach((n) -> {
                try {
                    modelSess.addRow(new Object[]{n.getDate(), n.getStartTime(), n.getCourseId(), n.getClassroomId(), n.getFile()});
