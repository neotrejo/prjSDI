...
public class CreateAccount extends javax.swing.JFrame implements readFingerPrintEvent {
    ...
    public CreateAccount(String title, Login parent) {
        initComponents();
    ...
    public static CreateAccount getInstance(String title, Login parent) {
        if (instance == null) {
            instance = new CreateAccount(title, parent);
        }
        return instance;
    }
